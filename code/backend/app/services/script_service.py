...
def _script_scene_prompt(
    ...
    return (
        ...
        "\"content_blocks\":["
        "{\"content_block_id\":\"CB001\",\"type\":\"action\",\"text\":\"...\",\"speaker\":null,\"parenthetical\":null,\"source_paragraph_ids\":[\"CH001_P001\"],\"source_evidence_ids\":[]},"
        "{\"content_block_id\":\"CB002\",\"type\":\"dialogue\",\"text\":\"...\",\"speaker\":\"角色名\",\"parenthetical\":\"低声\",\"source_paragraph_ids\":[\"CH001_P002\"],\"source_evidence_ids\":[]}]}\n"
        "Rules:\n"
        ...
        "- For dialogue blocks, write a short parenthetical performance direction (e.g. 低声, 颤抖, 冷笑, 激动, 平静). Describe how the line is delivered: the character's emotion, tone, volume, or physical state. Only omit parenthetical when the emotional tone of the line is obvious and neutral. For non-dialogue blocks, parenthetical must be null.\n"
...
def _script_scene_repair_prompt(
    ...
    return (
        ...
        "- Dialogue blocks should include a parenthetical performance direction describing how the line is delivered.\n\n"
